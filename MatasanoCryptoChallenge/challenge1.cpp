...
int main()
{
    ...
    HexConverter hex;
    Base64Converter b64;
    std::cout << "Original Hex: " << std::endl << originalHex << std::endl <<
              std::endl;
    std::cout << "As Text:" << std::endl << hex.decodeFromHex(
                  originalHex) << std::endl << std::endl;
    std::cout << "As Base64:" << std::endl << b64.encodeIntoBase64(
                  hex.decodeFromHex(originalHex));
